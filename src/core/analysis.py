...
if __name__ == "__main__":
    words = ["cat", "bat", "seed", "said", "fat", "feet", "feed", "feet"]
    chars = sorted({char for word in words for char in list(word)})

    char_dict = {}
    for char in chars:
        char_dict.update({char: generate_char_dictionary(char, words)})
